...
export default function AuthScreen() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Note: No need to set loading to false here as user will be redirected
    } catch (err) {
      setError(t('auth.unexpectedError'));
      setLoading(false);
    }
    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4" style={{
      ...
      <div className="w-full max-w-md mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="rounded-3xl overflow-hidden backdrop-blur-xl" style={{
          ...
          {/* Header */}
          <div className="relative p-6 sm:p-8 lg:p-10 text-center overflow-hidden" style={{
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-2 tracking-tight" style={{
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="mt-6 space-y-3">
              <button 
                ...
                disabled={loading}
                className="w-full py-3 rounded-xl font-bold text-white backdrop-blur-sm transition-all transform hover:scale-105 active:scale-95 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed" 
                style={{
